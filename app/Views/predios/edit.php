                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-actions float-end">
                                <a href="<?php echo base_url('/predio') ?>" class="me-1">
                                    <i class="fa-solid fa-arrow-left"></i> Return</a>
                                <a href="<?php echo base_url('/predio/edit?id=' . $_GET['id']) ?>" class="me-1">
                                    <i class="align-middle" data-feather="refresh-cw"></i> Refresh</a>
                            </div>
                            <h5 class="card-title mb-0">Editar Prédio</h5>
                        </div>
                        <div class="card-body">

                            <form id="formPredio" action="<?php echo base_url("predio/update"); ?>" method="POST">
                                <div class="row">
