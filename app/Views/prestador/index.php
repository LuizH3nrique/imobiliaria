    ...
    <div class="col-md-9 col-xl-10">
        <div class="tab-content">
            <div class="tab-pane fade" id="account" role="tabpanel">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5 class="card-title mb-0">Cadastrar Novo <?php echo $title ?></h5>
                    </div>
                    <div class="card-body">

                        <form id="formPredio" action="<?php echo base_url($dirView . "/save"); ?>" method="POST">
                            <div class="row">
            ...
            <div class="tab-pane fade show active" id="password" role="tabpanel">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Lista de <?php echo $title ?> Cadastrados</h5>
                            ...
                            <tbody>
                                <?php foreach ($prestador as $item) : ?>
                                    <tr>
                                        ...
                                        <td><a type="button" class="btn btn-warning" href="<?php echo base_url($dirView . '/edit?id=' . $item["id"]) ?>">Editar</a></td>
                                    </tr>
                                <?php endforeach
                                ?>
